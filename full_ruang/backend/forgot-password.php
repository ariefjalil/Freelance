					...
					<div class="col-md-4 saasappoint-login-right-block">
						...
						<form id="saasappoint_forgot_password_form" name="saasappoint_forgot_password_form">
							<div class="form-group">
								<label for="saasappoint_forgot_password_email">Sila masukkan email anda untuk set semula kata laluan.</label>
								<input type="text" class="form-control" id="saasappoint_forgot_password_email" name="saasappoint_forgot_password_email" placeholder="Masukkan email anda" />
							...
							<div class="col-md-12">
								<button type="submit" id="saasappoint_forgot_password_btn" class="btn float-right col-md-12">Set kata laluan</button>
							</div>
						</form>
						<br/>
						<br/>
						<p class="text-center mt-4"><a href="<?php echo SITE_URL; ?>backend/">Kembali ke laman log masuk</a></a></p>
					</div>
				</div>
			</div>
		</section>
