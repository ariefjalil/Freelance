			...
			<div class="saasappoint-tabbable-line">
				...
				<div class="tab-content">
					...
					<div class="tab-pane container fade" id="saasappoint_payment_settings">
					  <br/>
					  <div class="row pl-3">
						<label class="col-md-3">Pay Manually Payment Status</label>
						<label class="saasappoint-toggle-switch">
							<input type="checkbox" name="saasappoint_pay_at_venue_status" id="saasappoint_pay_at_venue_status" class="saasappoint-toggle-switch-input" <?php if($obj_settings->get_superadmin_option("saasappoint_pay_at_venue_status")=="Y"){ echo "checked"; } ?> />
