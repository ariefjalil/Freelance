...
== Changelog === 
2.6
* Ability to Enable/Disable Single Category & Service Auto Trigger ===> Added
* Minor issues ===> Fixed

2.5
* Business listing with performance point order ===> Added
* ManageablesShow points on listing page ===> Added
* Ability to delete Business ===> Added
* Reset business search on directory ===> Added
* Major issues ===> Fixed

2.4
* Manageable color and background of booking form ==> Added
* Manage schedule according service ==> Added 
* Welcome note befor booking form ==> Added
* Ability to edit & delete language =>Added
* Minor issues ==> Fixed 

2.3
* Service Duration ==> Added
* Booking Padding Time After ==> Added 
* Booking Padding Time Before ==> Added 
* Language Translation For Booking Form ==> Added
* Referral Code Enable/Disable From Settings ==> Added
* Pay Locally Enable/Disable From Settings ==> Added
* Addon Description On Booking Form ==> Added
* Auto Trigger Single Service , Single Category ==> Added
* Minor issues ==> Fixed
